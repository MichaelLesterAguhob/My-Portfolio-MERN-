...
const Projects = () => {
  ...
  return (
    <div
      id="projects"
      className="min-h-[calc(100vh-96px)] max-h-[calc(100vh-96px)] overflow-auto flex flex-col justify-center items-center p-2"
    >
      ...
      <div className="flex flex-col md:flex-row gap-5 overflow-x-scroll w-[95%]">
        <div className="w-full md:min-w-[385px] md:min-h-[500px] md:w-1/3">
          <Carousel>
            {slides.map((s) => (
              <img src={s} className="w-[100%] h-[100%] my-auto" />
            ))}
          </Carousel>
        </div>
