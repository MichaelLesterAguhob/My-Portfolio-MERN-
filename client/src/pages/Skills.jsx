    ...
    <div id="skills" className="min-h-[calc(100vh-96px)] flex flex-col justify-start items-center p-2">
      ...
      <div className="p-4 w-full flex-grow grid md:grid md:grid-cols-3 gap-4">
        <div className="bg-slate-600 rounded-[10px] p-2 flex flex-wrap gap-3 justify-center md:h-[300px] lg:h-auto">
          ...
          <img src="https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/tailwindcss-1633184775.webp" alt="tech image" className="w-[25%] h-[15%] min-h-[50px] min-w-[58px] bg-white rounded-lg"/>
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZZL_ST-vqpuo-5CcWVx3CPa6-l2pgDPvcfUDGKMigMabJf6-3r09qgbU7FYFaP05suFA" alt="tech image" className="w-[25%] h-[15%] min-h-[50px] min-w-[58px] bg-white rounded-lg"/>
          <img src="https://technowic.weebly.com/uploads/2/9/5/9/29593105/6625768_orig.jpg" alt="tech image" className="w-[25%] h-[15%] min-h-[50px] min-w-[58px] bg-white rounded-lg"/>
        ...
        <div className="bg-slate-600 rounded-[10px] p-2 flex flex-wrap gap-3 justify-center md:h-[300px] lg:h-auto">
          ...
          <img src="https://s1.o7planning.com/web-rs/web-image/en/arf-1024649-vi.webp" alt="tech image" className="w-[25%] h-[15%] min-h-[50px] min-w-[58px] bg-white rounded-lg"/>
          <img src="http://upload.wikimedia.org/wikipedia/commons/thumb/2/27/PHP-logo.svg/2560px-PHP-logo.svg.png" alt="tech image" className="w-[25%] h-[15%] min-h-[50px] min-w-[58px] bg-white rounded-lg"/>
          <img src="https://images.sftcdn.net/images/t_app-icon-m/p/917c77e8-96d1-11e6-8453-00163ed833e7/3780880766/mysql-com-icon.png" alt="tech image" className="w-[25%] h-[15%] min-h-[50px] min-w-[58px] bg-white rounded-lg"/>
        ...
        <div className="bg-slate-600 rounded-[10px] p-2 flex flex-wrap gap-3 justify-center md:h-[300px] lg:h-auto">
          ...
          <img src="https://logo-marque.com/wp-content/uploads/2021/02/Trello-Logo-2011-2016.png" alt="tech image" className="w-[25%] h-[15%] min-h-[50px] min-w-[58px] bg-white rounded-lg"/>
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSISdlTg7ChU0UJI8ZmvDDhyBBRVBGy8eptPz8Cy2ORuXQRA7242Y21RjdL-I-OpoZ1EDg" alt="tech image" className="w-[25%] h-[15%] min-h-[50px] min-w-[58px] bg-white rounded-lg"/>
