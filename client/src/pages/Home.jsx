...
const Home = () => {
  ...
  return (
    ...
    >
      <div className="w-full md:col-span-2 flex justify-center md:justify-end items-end md:items-center p-4 overflow-hidden">
        <img src={MyPhoto} alt='Michael Photo' className="w-full h-auto max-w-[340px] max-h-[340px]"/>
      </div>  

      <div className="w-full flex flex-col md:col-span-3  md:justify-center md:items-start overflow-hidden">
        ...
        <p className="w-full md:w-3/4 p-2 text-white text-2xl text-justify">Hi👋 I'm Michael and I am desktop software and web developer and <strong>I'm open for an entry level job.</strong> I love coding, building a software or website that let me turned ideas into reality.</p>
      </div>
    </div>
  );
};
